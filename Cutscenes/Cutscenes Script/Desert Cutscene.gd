...
@onready var canvas_layer = $"../Desert" # Adjust path to your CanvasLayer node
@onready var ui_follow_player = $"../Desert/Control"  # Adjust path to your Node2D or Control node under CanvasLayer
...
func _ready():
	...
	if has_node("/root/Level01/Cutscenes/Desert/Control"):
		control_node = get_node("/root/Level01/Cutscenes/Desert/Control")
