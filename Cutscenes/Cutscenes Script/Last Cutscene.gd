...
@onready var canvas_layer = $"../Last" # Adjust path to your CanvasLayer node
@onready var ui_follow_player = $"../Last/Control"  # Adjust path to your Node2D or Control node under CanvasLayer
...
func _ready():
	...
	if has_node("/root/Level01/Cutscenes/Last/Control"):
		control_node = get_node("/root/Level01/Cutscenes/Last/Control")
