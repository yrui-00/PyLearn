...
@onready var canvas_layer = $"../Forest" # Adjust path to your CanvasLayer node
@onready var ui_follow_player = $"../Forest/Control"  # Adjust path to your Node2D or Control node under CanvasLayer
...
func _ready():
	...
	if has_node("/root/Level01/Cutscenes/Forest/Control"):
		control_node = get_node("/root/Level01/Cutscenes/Forest/Control")
