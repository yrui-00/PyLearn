...
@onready var canvas_layer = $"../Snow" # Adjust path to your CanvasLayer node
@onready var ui_follow_player = $"../Snow/Control"  # Adjust path to your Node2D or Control node under CanvasLayer
...
func _ready():
	...
	if has_node("/root/Level01/Cutscenes/Snow/Control"):
		control_node = get_node("/root/Level01/Cutscenes/Snow/Control")
